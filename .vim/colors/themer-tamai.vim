if &background == 'dark'
  let s:guishade0 = "#181818"
  let s:guishade1 = "#393939"
  let s:guishade2 = "#595959"
  let s:guishade3 = "#7a7a7a"
  let s:guishade4 = "#9b9b9b"
  let s:guishade5 = "#bcbcbc"
  let s:guishade6 = "#dcdcdc"
  let s:guishade7 = "#fdfdfd"
  let s:guiaccent0 = "#ff006c"
  let s:guiaccent1 = "#f18250"
  let s:guiaccent2 = "#faff6f"
  let s:guiaccent3 = "#1cd836"
  let s:guiaccent4 = "#00c9f1"
  let s:guiaccent5 = "#0086ff"
  let s:guiaccent6 = "#7279ff"
  let s:guiaccent7 = "#ff5dff"
  ...
  let s:ctermaccent0 = 198
  let s:ctermaccent1 = 216
  let s:ctermaccent2 = 228
  let s:ctermaccent3 = 77
  let s:ctermaccent4 = 45
  let s:ctermaccent5 = 39
  let s:ctermaccent6 = 105
  let s:ctermaccent7 = 213
endif


highlight clear
syntax reset
let g:colors_name = "themer-tamai"
